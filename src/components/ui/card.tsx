...
>(({ className, ...props }, ref) => (
  <h2 // Changed div to h2 for better semantics
    ref={ref}
    className={cn(
      "text-2xl font-semibold leading-none tracking-tight text-card-foreground", // Explicitly set text color
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p // Changed div to p for better semantics
    ref={ref}
